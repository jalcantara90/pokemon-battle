 ...
 export function PokemonCard({ pokemon, skills = [], deletePokemon, selectPokemon }: PokemonCardProps) {
  ...
  return (
    <PokemonCardContainer>
      ...
      {
        selectPokemon && <PokemonSelectButtonContainer> <PokemonSelectButton onClick={() => {selectPokemon(pokemon)}}>I choose you!</PokemonSelectButton> </PokemonSelectButtonContainer>
      }
    </PokemonCardContainer>
  )
};
